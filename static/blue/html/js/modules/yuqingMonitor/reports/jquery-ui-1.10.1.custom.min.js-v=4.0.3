		...
		_mouseCapture: function(t) {
			...
			return this.helper || n.disabled || e(t.target).closest(".ui-resizable-handle").length > 0 ? !1 : (this.handle = this._getHandle(t), this.handle ? (e(n.iframeFix === !0 ? "iframe" : n.iframeFix).each(function() {
				e("<div class='ui-draggable-iframeFix' style='background: #fff;'></div>").css({
					...
					position: "absolute",
					opacity: "http://yuqing.gsdata.cn/themes/blue/html/js/modules/yuqingMonitor/reports/0.001",
					zIndex: 1e3
...
(function(e, t) {
	e.widget("http://yuqing.gsdata.cn/themes/blue/html/js/modules/yuqingMonitor/reports/ui.menu", {
		version: "1.10.1",
		defaultElement: "<ul>",
		delay: 300,
		options: {
...
(function(e, t) {
	...
	var n = 0,
		r = /#.*$/;
	e.widget("http://yuqing.gsdata.cn/themes/blue/html/js/modules/yuqingMonitor/reports/ui.tabs", {
		version: "1.10.1",
		delay: 300,
		options: {
			active: null,
